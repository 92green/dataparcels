...
Value can also accept [parcel updaters](/concepts/parcel-updaters). These pass the previous data held in state, and expect the new data to be returned. These can be useful for setting [parcel meta](/concepts/parcel-meta).
