...
Is true if the parcel is an indexed parcel. Read [Parcel types](/concepts/parcel-types) for more info.
...
Is true if the parcel is an element parcel. Read [Parcel types](/concepts/parcel-types) for more info.
