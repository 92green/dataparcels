...
The Parcel that will be sortable. This Parcel must be of type [IndexedParcel](/concepts/parcel-types#IndexedParcel), and an error will be thrown if it is not.
