...
update(asNodes((nodes: any) => any): Parcel
update(asShape((shape: ParcelShape) => any)): Parcel
```
...
update(asNodes((nodes: any, changeRequest: ChangeRequest) => any): Parcel
update(asShape((shape: ParcelShape, changeRequest: ChangeRequest) => any)): Parcel
```
