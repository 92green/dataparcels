...
update(updateShape(shapeUpdater: ParcelShapeUpdater)): ParcelShape
update(key: string|number, updateShape(updater: ParcelValueUpdater)): ParcelShape // only on ParentParcels, will update a child
...
// updates shape, including meta
updateIn(keyPath: Array<string|number>, updateShape(shapeUpdater: ParcelShapeUpdater)): ParcelShape // only on ParentParcels
type ParcelShapeUpdater = (parcelShape: ParcelShape) => any;
```
...
// updates shape, including meta
map(updateShape(shapeUpdater: ParcelShapeUpdater)): ParcelShape // only on ParentParcels
type ParcelShapeUpdater = (parcelShape: ParcelShape) => any;
```
